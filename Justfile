...
charts: (_build "charts/escucha-el-ritmo.ly") (_build "charts/fuego-en-el-23.ly") (_build "charts/la-rebelion.ly") (_build "charts/lazaro-y-su-microfono.ly")  (_build "charts/changuito-se-boto.ly")