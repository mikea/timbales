...
\newTimbalesStaff <<
    ...
    \autoLineBreaksOff
        ...
        \sectionLabel "(piano + guiro)" r1 | r1 | r2 r4 <<cb4^>~ >> | \bar "||"
    ...
    \repeat volta 3 {
        ...
        \alternative {
            ...
            \volta 3 { <<cb4>> r8 cb8 r8 cb8 r4 | \bar "||" }
        }
    }
        cb4^>  cb4^> cb4^> cb8 cb8  | cb4^>  r4 r2 |
    \autoLineBreaksOn
        ...
        timl4 cymc4 \rs \rs | \comp #4 | \comp #4 | \only-last cb4 cb8 cb8^> r8 cb8 cb4^> | \bar "||"
        ...
        \bar ":|][|:"        
        \comp #4 | \comp #4 | \comp #4 | \comp #4 | \bar "||"
        \comp #4 | \rs \rs r8 cymc8 r8 cymc8~ | cymc4 r8 cymc8~ cymc4 r8 cymc8~ | cymc4 r8 cymc8~ cymc4 cb4^> | \bar "||"
        \bar ":|]"        
