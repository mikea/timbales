...
\newTimbalesStaff <<
    ...
    \repeat volta 2 {
        ...
        <<cb4 timl>> <<cb8 timl>> <<cb8 timl>> <<cb4 timl>> <<cb4 timl>> | 
        r4 timh4:16~ timh8^> timh8^> timh4^>  |
    ...
    \repeat volta 2 {
        ...
        \alternative {
          ...
          \volta 2 { \rs \rs \rs \drag timh4^> | <<cb4 timl>> <<cb8 timl>> <<cb8 timl>> r8 <<cb8 timl>> r8 <<cb8 timl>> | \bar "||" }
        }
    }
    ...
    \autoLineBreaksOn
        ...
        <<cymc4 timh>> r4 r2 | 
        \textMark "rit." <<cymc4 timl4>> <<cymc4 timh4>> <<cymc4 timl4>> <<cymc4 timh4>> | r2  \fermata timl2:16 \fermata |
        \bar "|."

\pageBreak

        \sect "E" "Edgardo Moralez (47 bars)"
        ...
        \tuplet 3/2 { \flam-art timh4^> timl4 4 }  \flam-art timh4^>  r4 | 
        \bar ".."
    }
>>
